...
HD_PWD='C:/Users/alber/Desktop/Verilog-FPGA-Experiments/SevenSegmentDisplay/SevenSegmentDisplay/SevenSegmentDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_SS_Output.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FA_SS_Output.tcl -notrace
