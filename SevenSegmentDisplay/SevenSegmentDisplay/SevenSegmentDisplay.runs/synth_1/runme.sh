...
HD_PWD='C:/Users/alber/Desktop/Verilog-FPGA-Experiments/SevenSegmentDisplay/SevenSegmentDisplay/SevenSegmentDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_SS_Output.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_SS_Output.tcl
